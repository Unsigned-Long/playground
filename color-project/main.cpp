...
int main(int argc, char const *argv[])
{
    ...
    file.close();
    auto min_max = std::minmax_element(ps.cbegin(), ps.cend(), [](const cv::Point3f &p1, const cv::Point3f &p2)
                                       { return p1.z < p2.z; });
    ...
    for (int i = 0; i != img.rows; ++i)
    {
        ...
        {
            auto [r, g, b] = ColorPrj::project(ps.front().z, min, max, false, 5, Color::orange);
